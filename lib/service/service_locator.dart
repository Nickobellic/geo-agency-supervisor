...
Future<void> main() async{
    ...
    builder.add((container) => LoginService(localRep: LoginRepositoryLocalImpl(), remoteRep: LoginRepositoryRemoteImpl())); // For Login Service
    builder.add((container) => LoginDetailsModelImpl(loginService: container<LoginService>())); // For Login View Model
    builder.add((container) => AgentLocationService(localRep: AgentLocationsLocalImpl())); // For Agent Location Service
    builder.add((container) => AgentLocationsViewModelImpl(agentLocationService: container<AgentLocationService>())); // For Agent Location View Model
